...
<head>
    ...
    <title>PatronBank | Cписок користувачів</title>
        ...
        <div class="sidebar">
            ...
            <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                ...
                <div class="info">
                    ...
                    <a class="text-gray"> Адміністратор </a>
                </div>
            </div>
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">Cписок користувачів</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                    ...
                    <table class="table table-head-fixed text-nowrap">
                        ...
                        if($result->num_rows==0){
                            ...
                            <tr>
                                ...
                                <td>$user[birthday]</td>
                                <td>$user[created]</td>
                                <td><a href="./admin-users-list.php?userUpdateId=$user[id]"><button class="btn btn-primary">Змінити</button></a></td>
                                <td><a href="./admin-users-list.php?userDeleteId=$user[id]"><button class="btn btn-danger">Видалити</button></a></td>                     
                            </tr>
                        TABLEUSERS;
                        }
                        }
...
ERROR;
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Змінити дані користувача</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
...
UPDATEUSER;
                ...
                echo <<< UPDATEUSER
                  ...
                  <div class="form-group">
                    <label for="exampleInputPassword1">Ел.пошта</label>
...
UPDATEUSER;
                  ...
                  <div class="form-group">
                    <label for="exampleInputPassword1">День народження</label>
                    <input type="date" class="form-control" id="exampleInputPassword1" value="$upd_user[birthday]" name="день_народження">
                  </div>
                  <div class="form-group mb-0">
                    <div class="form-check">
                        <input type="checkbox" class="form-check-input" id="exampleCheck1" name="check">
                        <label class="form-check-label" for="exampleCheck1">Підтвердити зміни</label>
                    </div>
                  </div>
                </div>
                <!-- /.card-body -->
        ...
        UPDATEUSER;
            ...
            <div class="card card-danger">
              <div class="card-header">
                <h3 class="card-title">Видалити користувача</h3>
              </div>
              <div class="card-body">
                <div class="row">
                  <div class="col-10">
                  <p>Ви впевнені що бажаєте видалити користувача? $del_user[firstName] $del_user[lastName] ?</p>
                  </div>

                  <div class="col-2">
                    <a href="../../scripts/delete-user.php"><button type="submit" class="btn btn-primary">Так,я впевнений</button></a>
                    <a href="./admin-users-list.php"><button type="submit" class="btn btn-gray">Ні, я не впевнений</button></a>
                  </div>
                </div>
              </div>
              <!-- /.card-body -->
