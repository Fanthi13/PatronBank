...
<head>
    ...
    <title>PatronBank | Список користувачів</title>
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>Списко користувачів</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="#">Домашня сторінка</a></li>
                            <li class="breadcrumb-item active">Список користувачів</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                    ...
                    <table class="table table-head-fixed text-nowrap">
                        ...
                        if($result->num_rows==0){
                            ...
                            <tr>
                                ...
                                <td>$user[birthday]</td>
                                <td>$user[created]</td>
                                <td><a href="./moder-users-list.php?userUpdateId=$user[id]"><button class="btn btn-primary">Змінити</button></a></td>                  
                            </tr>
                        TABLEUSERS;
                        }
                        }
...
ERROR;
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Змінити користувача</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
...
UPDATEUSER;
                  ...
                  <div class="form-group mb-0">
                    <div class="form-check">
                        ...
                        <label class="form-check-label" for="exampleCheck1">Підтвердити зміни користувача</label>
                    </div>
                  </div>
                </div>
                <!-- /.card-body -->
                <div class="card-footer">
                  ...
                  <a href="./moder-users-list.php"><button type="button" class="btn btn-gray">Назад</button></a>
                </div>
              </form>
            </div>
        UPDATEUSER;
