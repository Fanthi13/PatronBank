...
if (!isset($_SESSION['loggedin']) || session_status() != 2 || session_id() != $_SESSION['session_id']) {
    $_SESSION["error"] = "Увійдіть в акаунт";
...
if ($stmt->num_rows > 0) {
    ...
    $formattedBirth = date("d m Y", strtotime($birthday));
    $formattedCreated = date("H:i d m Y", strtotime($created_at));
}
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>PatronBank | Cторінка профілю</title>
    ...
    <div class = "row">
                    ...
                    <div class="card-body box-profile">
                        ...
                        <ul class="list-group list-group-unbordered mb-3">
                            <li class="list-group-item">
                                <b><i class="fas fa-user mr-2"></i> Акаунт ID <a class="float-right"><?php echo $account; ?></a></b>
                            </li>
                            <li class="list-group-item">
                                <b><i class="fas fa-map-marker-alt mr-2"></i> Адреса</b> <a class="float-right"><?php echo $city . " / " . $state . " / " . $country ?></a>
                            </li>
                            <li class="list-group-item">
                                <b><i class="fas fa-mail-bulk mr-2"></i>Ел.пошта</b> <a class="float-right"><?php echo $_SESSION['email'];?></a>
                            </li>
                            <li class="list-group-item">
                                <b><i class="fas fa-birthday-cake mr-2"></i>День народження</b> <a class="float-right"><?php echo $formattedBirth; ?></a>
                            </li>
                            <li class="list-group-item">
                                <b><i class="fas fa-tools mr-2"></i>Дата створення акаунту</b> <a class="float-right"><?php echo $formattedCreated; ?></a>
                            </li>
                        </ul>
                    </div>
                    <!-- /.card-body -->
            ...
            <div class="col-md-7">
                <div class="card card-primary">
                    ...
                    <div class="card-body">
                        <strong><i class="fas fa-money-bill mr-1"></i> Баланс</strong>
                        <p class="text-muted">
                        <?php
                        require_once "../../scripts/connect.php";
                ...
                <div class="card card-primary">
                    ...
                    if($result->num_rows==0){
                        $lastR = "Ви ще не проводили жодної транкзакції!";
                        $lastS = "Ви ще не проводили жодної транкзакції!";
                        $DateO= "Ви ще не проводили жодної транкзакції!";
                        $AmountO = "Ви ще не проводили жодної транкзакції!";
                    }else {
                    ...
                    <!-- /.card-header -->
                    <div class="card-body">
                        <strong><i class="fas fa-user-clock mr-1"></i> Останій отримувач</strong>

                        <p class="text-muted"><?php  echo $lastR ?></p>

                        <hr>

                        <strong><i class="fas fa-user-clock mr-1"></i> Останій відправник</strong>

                        <p class="text-muted"><?php echo $lastS ?></p>

                        <hr>

                        <strong><i class="fas fa-clock mr-1"></i> Дата останньої транкзакції</strong>

                        <p class="text-muted"><?php echo $DateO ?></p>

                        <hr>

                        <strong><i class="fas fa-money-bill mr-1"></i> Сума останньої операції</strong>
